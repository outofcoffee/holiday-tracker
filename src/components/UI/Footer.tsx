...
const Footer = () => {
  return (
    <footer className="bg-gray-100 p-4 mt-4 text-center text-gray-600 text-sm">
      <p>
        {holidayMessages.footerGreeting} {new Date().getFullYear()}
      </p>
      ...
      <p className="mt-2">
        <a
          ...
          onMouseOver={(e) => (e.currentTarget.style.color = holidayColors.primary)}
          onMouseOut={(e) => (e.currentTarget.style.color = holidayColors.dark)}
        >
