...
export const christmasConfig: HolidayConfig = {
  ...
  facts: [
    {
      id: 1,
      text: 'Santa Claus is based on St. Nicholas, a Christian bishop who lived in the 4th century!',
    },
    {
      id: 2,
      text: 'Rudolph the Red-Nosed Reindeer was created for a Montgomery Ward coloring book in 1939!',
    },
    {
      id: 3,
      text: 'The tradition of leaving milk and cookies for Santa started in the United States during the Great Depression!',
    ...
    {
      id: 8,
      text: 'Santa\'s reindeer names come from the 1823 poem "A Visit from St. Nicholas"!',
    },
    {
      id: 9,
    ...
    {
      id: 12,
      text: 'The modern image of Santa in a red suit was popularised by Coca-Cola advertisements in the 1930s!',
    },
    {
      id: 13,
    ...
    {
      id: 14,
      text: 'The name "Santa Claus" comes from the Dutch "Sinterklaas"!',
    },
    {
      id: 15,
      text: 'In the UK, Father Christmas was originally part of pagan midwinter festivals!',
